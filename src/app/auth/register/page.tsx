        ...
        <CardBody>
          ...
          >
            ...
            {password.length > 0 && (
              <div className="text-xs space-y-1 mt-1">
                <div className="flex items-center">
                  ...
                  <span
                    className={hasMinLength ? 'text-success' : 'text-danger'}
                  >
                    حداقل 8 کاراکتر
                  </span>
                </div>
                <div className="flex items-center">
                  ...
                  <span
                    className={hasLowerCase ? 'text-success' : 'text-danger'}
                  >
                    شامل حروف کوچک
                  </span>
                </div>
                <div className="flex items-center">
                  ...
                  <span
                    className={hasUpperCase ? 'text-success' : 'text-danger'}
                  >
                    شامل حروف بزرگ
                  </span>
                </div>
            ...
            <Input
              ...
              errorMessage={
                errors.confirmPassword?.message || passwordMatchError
              }
